...
export default function App(props: IAppProps) {
  return (
    <div className="container mx-auto p-5">
      ...
      <p className="pt-2">      
        Siloah Travel Co., Ltd. built the Siloah Travel app as a Free app. This
        SERVICE is provided by Siloah Travel Co., Ltd. at no cost and is
        ...
        Terms and Conditions, which are accessible at Siloah Travel unless
        otherwise defined in this Privacy Policy. Information Collection and Use
        For a better experience, while using our Service, we may require you to
        provide us with certain personally identifiable information, including
        but not limited to name, mobile. The information that we request will be
        ...
        providers used by the app. Google Play Service
      </p>
      <h3 className="text-lg mt-3 font-bold">Log Data</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Cookies</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Service Providers</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Security</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Links to Other Sites</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Children’s Privacy</h3>
      <p>
      ...
      <h3 className="text-lg mt-3 font-bold">Changes to This Privacy Policy</h3>
      <p>
        We may update our Privacy Policy from time to time. Thus, you are
        advised to review this page periodically for any changes. We will notify
        you of any changes by posting the new Privacy Policy on this page. This
        policy is effective as of 2022-03-16
      </p>
      <h3 className="text-lg mt-3 font-bold">Contact Us</h3>
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at siloah.dev@gmail.com.
      </p>{" "}
    </div>
  );
}
